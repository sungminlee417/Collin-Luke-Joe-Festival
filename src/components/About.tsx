...
const About = () => {
  const staff = [
    ...
    },
    {
      ...
      role: "Co-Artistic Director",
      image: collinImage,
      bio: "Classical guitarist Collin Holloway began playing at the age of nine in his hometown of Oklahoma City.",
    },
    {
      name: "Luke Benedict",
      role: "Co-Artistic Director",
      image: lukeImage,
      bio: "Luke Benedict is a pianist and composer born in 1996, who studied piano performance at Eastman School of Music and Boston Conservatory of Music, where he studied under Rebecca Penneys and Michael Lewin. ",
    },
  ];
              ...
              <div className="bg-gray-100 rounded-lg p-4 h-full flex flex-col justify-between">
                <div>
                  <img
                    ...
                    alt={member.name}
                    className="w-full rounded-lg mb-2 h-52 object-cover cursor-pointer"
                    onClick={toggleBio}
                  />
