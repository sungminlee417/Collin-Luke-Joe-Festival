...
const LandingPage = () => {
  return (
    <>
      ...
      >
        <div className="title absolute flex flex-col justify-center lg:text-10xl text-[#7895B2] h-full font-family: merriweather font-semibold text-center md:text-9xl text-8xl p-4">
