...
const LandingPage = () => {
  return (
    <>
      ...
      >
        <div className="title absolute flex flex-col justify-center lg:text-10xl text-[#1A374D] h-full font-family: 'Yeseva One' font-semibold text-center md:text-9xl text-8xl p-4">
