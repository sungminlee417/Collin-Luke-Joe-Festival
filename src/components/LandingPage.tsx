...
const LandingPage = () => {
  return (
    <>
      ...
      >
        <div className="title absolute flex flex-col justify-center lg:text-10xl text-[#3A6351] h-full font-merriweather font-semibold text-center md:text-9xl text-8xl p-4">
