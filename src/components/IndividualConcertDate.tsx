    ...
    >
      <div className="flex flex-col lg:flex-row gap-6 md:gap-14">
        ...
        <div className="flex flex-col gap-6">
          <div className="text-2xl md:text-4xl font-bold">{event.title}</div>
          <div className="flex items-center gap-4 md:gap-6 md:text-md">
      ...
      <div className="flex justify-between md:justify-center items-center mt-2 md:mt-0 lg:ml-auto">
        <Tooltip
        ...
        >
          <a
            ...
            className="flex justify-center items-center w px-6 py-2 rounded-md bg-[#579BB1] text-white text-md font-bold hover:bg-[#4e8b9f] transition"
          >
            Tickets
          </a>
        </Tooltip>
