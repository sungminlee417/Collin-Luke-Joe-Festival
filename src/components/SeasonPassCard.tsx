const SeasonPassCard = () => {
  return (
    <li className="bg-white p-6 md:p-10 rounded-md shadow-lg transition transform hover:scale-105 md:mx-0 mx-4 flex lg:flex-row gap-14 flex-col justify-between">
      <div>
        <div className="text-6xl text-gray-900 font-extrabold mb-4">
          SEASON PASS
        </div>
      ...
      <div className="flex justify-center items-center">
        <a
          ...
          className="flex justify-center items-center px-8 py-4 w-fit rounded-md bg-[#579BB1] text-white text-xl font-bold hover:bg-[#4e8b9f] transition duration-300"
        >
          Get Your Pass Now!
        </a>
      </div>
